...
class FabButton extends StatefulWidget {
  ...
  ///
  /// Only one [FabButton] can be used per page.
  ///
...
class FabButtonState extends State<FabButton> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    Widget retorno = FabButtonInicialAnimation(
        controller: this._inicialController.view,
        color: widget.color,
        margin: widget.margin);
    switch (this._status) {
      case ButtonStatus.Inicial:
        retorno = FabButtonInicialAnimation(
            controller: this._inicialController.view,
            color: widget.color,
            margin: widget.margin);
        break;
      ...
      case ButtonStatus.Loading:
        retorno = FabButtonLoadingAnimation(
      ...
      case ButtonStatus.Transiting:
        retorno = FabButtonTransitioningAnimation(
...
class FabButtonInicialAnimation extends StatelessWidget {
  FabButtonInicialAnimation({this.controller, this.color, this.margin})
...
class FabButtonLoadingAnimation extends StatelessWidget {
  FabButtonLoadingAnimation({this.controller, this.color, this.margin})
...
class FabButtonTransitioningAnimation extends StatelessWidget {
  FabButtonTransitioningAnimation({this.controller, this.color, this.margin})
